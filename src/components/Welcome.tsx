...
export const Welcome = () => {
  return (
    <div className="w-full h-screen text-zinc-100 flex flex-col  items-center justify-center relative">
      <div className="w-full h-full flex flex-col justify-start">
        <img className="max-w-4xl absolute right-0  -z-10 translate-x-60 translate-y-80 bottom-0" src={'/public/greenplanet.png'} />
        <motion.p
